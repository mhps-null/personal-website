const SOCIALS = [
    ...
    {
        name: 'Instagram',
        href: 'https://instagram.com/mharisputras',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
    ...
    {
        name: 'Discord',
        href: 'https://discord.com/users/486492676619894784',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
...
const Footer = () => {
    ...
    return (<footer className="w-full border-t border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 duration-300">
